...
import '@pbeefswap/beefswap-swap-lib/contracts/math/SafeMath.sol';
import '@beefswap/beefswap-swap-lib/contracts/token/BEP20/IBEP20.sol';
import '@beefswap/beefswap-swap-lib/contracts/token/BEP20/SafeBEP20.sol';
import '@beefswap/befswap-swap-lib/contracts/utils/ReentrancyGuard.sol';
...
contract IBO is ReentrancyGuard {
  ...
  function deposit(uint256 _amount) public {
    require (block.number > startBlock && block.number < endBlock, 'not ibo time');
